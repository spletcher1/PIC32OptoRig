...
#define LEDSTRING1_ON() _LATE0=1
#define LEDSTRING2_ON() _LATE1=1
#define LEDSTRING3_ON() _LATE2=1
#define LEDSTRING4_ON() _LATE3=1
#define ALLLED_ON() LATESET = 0x0F


#define LEDSTRING1_OFF() _LATE0=0
#define LEDSTRING2_OFF() _LATE1=0
#define LEDSTRING3_OFF() _LATE2=0
#define LEDSTRING4_OFF() _LATE3=0
#define ALLLED_OFF() LATECLR = 0x0F


#define LEDSTRING1_PORT _RE0
#define LEDSTRING2_PORT _RE1
#define LEDSTRING3_PORT _RE2
#define LEDSTRING4_PORT _RE3

#define LEDSTRING1_TRIS _TRISE0
#define LEDSTRING2_TRIS _TRISE1
#define LEDSTRING3_TRIS _TRISE2
#define LEDSTRING4_TRIS _TRISE3
